...
export default function Acadamics_sc(){
    ...
    let admisidrm = document.querySelector("div#slide-panel")
    admisidrm.style.display = "none"
    let ytsubrm = document.querySelector('.text-center')
    ytsubrm.style.display = "none"
    let tolirm = document.querySelector('.insti wow fadeInLeft  ')
    tolirm.style.display = "none"
